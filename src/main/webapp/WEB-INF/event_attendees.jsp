...
<body>
	...
	<div class="container">
		...
		<h2 class="header text-center"><c:out value="${event.name}"></c:out>'s Walk</h2>
			<table class="table table-hover col-6">
				...
				<tbody>
					<c:forEach var="attendee" items="${rsvps}">
						<tr>
							<td><c:out value="${attendee.userName}"></c:out></td>
							<td><c:out value="${attendee.email}"></c:out></td>
							<td>
							<c:forEach var="club" items="${attendee.clubs}">
